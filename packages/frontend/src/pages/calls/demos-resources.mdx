...
description: The BPM 2025 Demos & Resources Forum showcases innovative Business Process Management (BPM) tools, services, and applications, as well as resources such as datasets, taxonomies, labelled event logs and annotated corpora alike, quantitative/qualitative data and benchmarks, that may originate either from academic initiatives or industry endeavors.
---
