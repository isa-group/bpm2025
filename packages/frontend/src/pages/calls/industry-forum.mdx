...
description: The BPM Industry & Society Forum has emerged as a significant platform for bridging the gap between academia and industry and the public sector, fostering meaningful connections among BPM experts worldwide
---
...
Please submit your insights using the [BPM 2025 EasyChair submission site](https://easychair.org/conferences/?conf=bpm2025) (Select Industry & Society Forum).
The paper must adhere to CEURART submission formatting guidelines
([check instructions and style sheets](https://ceurws.wordpress.com/2020/03/31/ceurws-publishes-ceurart-paper-style/)).
The length of the paper should be maximum 10 pages. At least one author of each accepted case must register for the conference and present the paper.
...
- André Coners, South Westphalia University of Applied Sciences, Germany
- Benjamin Matthies, Münster University of Applied Sciences, Germany
- Carlos Fernández Llatas, Universidad Politécnica de Valencia, Spain
- Clara Ziche, ÖBB-Infrastruktur AG, Austria
- Felix Mannhardt, Eindhoven University of Technology, Netherlands
- Ingo Kregel, University of Applied Sciences and Arts Dortmund, Germany
- Jannis Nacke, Enervie-Group, Germany
- Jelmer Koorn, MLC, Netherlands
- Michael Hewing, Münster University of Applied Sciences, Germany
- Ramon Canelo Gil, Cenit S.L., Spain
- Saimir Bala, Humboldt-Universität zu Berlin, Germany
- Søren Debois, DCR Solutions A/S, Denmark
- Thomas Hildebrandt, University of Copenhagen, Denmark
- Timotheus Kampik, Umeå universitet / SAP, Sweden
- Urszula Jessen, ECE Group Services, Germany
