<template>
  <div class="min-h-screen bg-gray-50 dark:bg-gray-900">
    ...
    <!-- Filter Overlay -->
    <OverlayPanel ref="op" @show="showFilterOptions = true" @hide="showFilterOptions = false">
      <div class="p-6 min-w-80 bg-white dark:bg-gray-800 rounded-xl shadow-lg">
        <h3 class="text-lg font-semibold mb-6 text-gray-900 dark:text-white">Filter Gallery</h3>
    ...
    <div class="px-4 py-6 pb-20">
      ...
      <!-- Gallery Grid -->
      <div v-if="images.length > 0" class="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-3">
        <div 
      ...
      <!-- Empty state -->
      <div v-else-if="!hasMore && images.length === 0" class="text-center py-16">
        <div class="mb-6">
          <div class="w-20 h-20 mx-auto bg-gray-100 dark:bg-gray-800 rounded-full flex items-center justify-center">
            <svg class="w-10 h-10 text-gray-400" viewBox="0 0 32 32" fill="currentColor">
...
const op: Ref<InstanceType<typeof OverlayPanel> | null> = ref(null);
